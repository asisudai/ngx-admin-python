                ...
                <ul class="list">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse "
                            ...
                            >
                                <li class="link">
                                    <a href="../interfaces/INameInterface.html"  data-type="entity-link" class="active" >INameInterface</a>
                                </li>
                                <li class="link">
    ...
    <div class="tab-pane fade active in" id="info">
        ...
        <section>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                            <tr>
                                <td class="col-md-4">
                                    <a name="getName"></a>
                                    <span class="name"><b> getName</b><a href="#getName"><span class="fa fa-link"></span></a></span>
                                </td>
                            </tr>
                            <tr>
                                <td class="col-md-4">
            <code>getName()</code>
                                    ...
                                    <tr>
                                        <td class="col-md-4">
                                            <div class="io-line">Defined in <a href="" data-line="18" class="link-to-prism">test/src/typedoc-examples/src/classes.ts:18</a></div>
                                        </td>
                                    </tr>
            
                            <tr>
                                <td class="col-md-4">
                                        <div class="io-description"><p>This is a interface function of INameInterface.</p>
                    ...
                    <table class="table table-sm table-bordered">
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="col-md-4">
                                            <div class="io-line">Defined in <a href="" data-line="11" class="link-to-prism">test/src/typedoc-examples/src/classes.ts:11</a></div>
                                        </td>
                                    </tr>

                            <tr>
                                <td class="col-md-4">
                                    <div class="io-description"><p>This is a interface member of INameInterface.</p>
<p>It should be inherited by all subinterfaces.</p>
</div>
                                </td>
                            </tr>
