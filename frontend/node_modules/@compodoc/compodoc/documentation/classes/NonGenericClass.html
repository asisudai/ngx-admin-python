                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse "
                            ...
                            >
                                ...
                                <li class="link">
                                    <a href="../classes/NonGenericClass.html"  data-type="entity-link" class="active" >NonGenericClass</a>
                                </li>
                                <li class="link">
...
<div class="tab-content">
    <div class="tab-pane fade active in" id="info">
        ...
        <p class="comment">
            ...
            <p class="comment">
                <p>This a non generic class derived from a [[GenericClass|generic class]].</p>
            ...
            <p class="comment">
                    <code><a href="../classes/GenericClass.html" target="_self" >GenericClass</a></code>
            </p>
